...
backend or any SDK checkout. Version 0.1.3 is the current release; 0.1.0 was the first.
...
make package              # dist/jelto-contracts-0.1.3.zip and .zip.sha256
```
...
The Go module is `jelto.io/jelto/contracts`, currently version **0.1.3**. Backend
...
```sh
python3 install.py /absolute/path/jelto-contracts-0.1.3.zip SHA256 /absolute/path/contracts
```
